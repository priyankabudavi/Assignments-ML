...
#read  the image
GrayBanana = cv2.imread('Grey_Image0.jpg')
#print the original dimensions
print("Original Dimensions:" ,GrayBanana.shape )

height = (GrayBanana.shape[0])/2
width = (GrayBanana.shape[1])/2
...
image_resized = cv2.resize(GrayBanana, dsize = (new_height , new_width))
cv2.imwrite('Banana_imagedim_div8.jpg' , image_resized)


#Read for Apple 

print("Calculating dimensions for Apple:")
Grayapple = cv2.imread('Grey_Image1.jpg')
#print the original dimensions
print("Original Dimensions:" ,Grayapple.shape )


height = (Grayapple.shape[0])/2
width = (Grayapple.shape[1])/2
...
print("New Dimension divisible by 8 :" , new_height, new_width )
image_resized = cv2.resize(Grayapple, dsize = (new_height , new_width))
cv2.imwrite('Apple_imagedim_div8.jpg' , image_resized)

print("Calculating dimensions for Guava:")
