...
x_train = pd.read_csv('C:/Users/p_bud/OneDrive/Desktop/Assignment/Big Data ML/Priyanka_Budavi_Submission_ML/Assignment2/Data/Training Dataset/Train_Image012_NonOverlap.csv' , header = None)
x_test = pd.read_csv('C:/Users/p_bud/OneDrive/Desktop/Assignment/Big Data ML/Priyanka_Budavi_Submission_ML/Assignment2/Data/Testing Dataset/Test_Image012_NonOverlap.csv' , header = None)
...
#yhatTrain_saved.to_csv('C:/Users/p_bud/OneDrive/Desktop/Assignment/Big Data ML/Priyanka_Budavi_Submission_ML/Assignment2/Data/Training Dataset/LassoTrain_Image01_NonOverlap_result.csv', index=False)
...
#yhat_saved.to_csv('C:/Users/p_bud/OneDrive/Desktop/Assignment/Big Data ML/Priyanka_Budavi_Submission_ML/Assignment2/Data/Testing Dataset/LassoTest_Image01_NonOverlap_result.csv', index=False)
...
print('sklearn.metrics Accuracy',accuracy_score(test_y, yhat_saved))
print('sklearn.metrics precision',precision_score(test_y, yhat_saved , average='macro'))
print('sklearn.metrics sensitivity',recall_score(test_y, yhat_saved , average='macro'))
